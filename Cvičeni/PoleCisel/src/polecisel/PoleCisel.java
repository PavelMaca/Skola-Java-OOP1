...
//             soucinPrvku *= poleCisel[i];
    ...
    public static void testMergeSort() {
        for (int i = 0; i < 3; i++) {
            PoleCisel novePole = new PoleCisel(10, 10);
            System.out.println("pole pred razenim");
            System.out.println("" + novePole);
            novePole.mergeSort(0, 9);
            System.out.println("pole po razeni");
            System.out.println("" + novePole);
        }
    }
    ...
    public static boolean testMergeSort(int pocetPrvku, int rozsah) {
        ...
        for (int i = 0; i < novePole.poleCisel.length - 1; i++) {
            if (novePole.poleCisel[i] > novePole.poleCisel[i + 1]) {
                return false;
            }
        }
        return true;
    ...
    public static void main(String[] args) {
        System.out.println("Test MergeSort: " + testMergeSort(1000000,1000000));
        testSoucinPrvku();
    }
